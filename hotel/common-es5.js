...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  function srcAppServicesAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(AuthService, [{
        ...
        value: function login(data) {
          ...
          return this.api.post('auth:login', data).then(function (res) {
            if (res.isAuth) _this.data.setUser(res.user);
            return res.isAuth;
          });
        }
      }, {
        ...
        value: function changePassword(password) {
          return this.api.post('auth:change-password', password).then(function (res) {
            return res;
          });
        }
      }, {
        ...
        value: function logout() {
          return this.api.post('auth:logout', null).then(function (res) {
            return res;
          });
        }
      }]);
    ...
    AuthService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"], _data_service__WEBPACK_IMPORTED_MODULE_3__["DataService"]])], AuthService);
    /***/
  }
}]);
