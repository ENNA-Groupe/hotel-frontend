...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["sorties-sorties-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesPrivateSortiesSortiesPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesPrivateSortiesSortiesModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SortiesPageModule", function () {
      return SortiesPageModule;
    });
    /* harmony import */
    ...
    var _sorties_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./sorties.page */
    ...
    var SortiesPageModule = function SortiesPageModule() {
      _classCallCheck(this, SortiesPageModule);
    };

    SortiesPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppPagesPrivateSortiesSortiesPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesPrivateSortiesSortiesPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SortiesPage", function () {
      return SortiesPage;
    });
    /* harmony import */
    ...
    var src_app_components_sortie_form_sortie_form_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! src/app/components/sortie-form/sortie-form.component */
    "./src/app/components/sortie-form/sortie-form.component.ts");
    /* harmony import */


    var src_app_components_sortie_profil_sortie_profil_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! src/app/components/sortie-profil/sortie-profil.component */
    ...
    /*#__PURE__*/
    function () {
      function SortiesPage(modalController, data, sortieService, userService, router) {
        _classCallCheck(this, SortiesPage);
      ...
      _createClass(SortiesPage, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this = this;

          this.sortieSubscription = this.sortieService.getSorties().subscribe(function (res) {
            _this.sorties = res;
          });
          this.sortieTrashSubscription = this.sortieService.getSortiesTrash().subscribe(function (res) {
            _this.sortiesTrash = res;
          });
        }
      }, {
        key: "ngOnDestroy",
                ...
                switch (_context.prev = _context.next) {
                  ...
                  case 2:
                    ...
                    modal.onDidDismiss().then(function (res) {
                      ...
                      if (res.data) _this2.sortieService.addSortie(res.data);
                    });
                    _context.next = 6;
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 2:
                    ...
                    modal.onDidDismiss().then(function (res) {
                      if (res.data) _this3.sortieService.editSortie(res.data);
                    });
                    _context2.next = 6;
                    return modal.present();
        ...
        key: "getUserNom",
        value: function getUserNom(id) {
          return this.userService.getUser(id).nom;
        }
      }, {
        key: "loadData",
        value: function loadData(event) {
          if (!this.trash) this.sortieService.getServerSorties();else this.sortieService.getSeverSortiesTrash();
        }
      }]);
    ...
    SortiesPage.ctorParameters = function () {
      return [{
    ...
    SortiesPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-sorties',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./sorties.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/private/sorties/sorties.page.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./sorties.page.scss */
      "./src/app/pages/private/sorties/sorties.page.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"], src_app_services_data_service__WEBPACK_IMPORTED_MODULE_3__["DataService"], src_app_services_sortie_service__WEBPACK_IMPORTED_MODULE_4__["SortieService"], src_app_services_user_service__WEBPACK_IMPORTED_MODULE_8__["UserService"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"]])], SortiesPage);
    /***/
  }
}]);
//# sourceMappingURL=sorties-sorties-module-es5.js.map