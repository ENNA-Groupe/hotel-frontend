...
let AuthService = class AuthService {
    ...
    login(data) {
        return this.api.post('auth:login', data).then((res) => {
            if (res.isAuth)
    ...
    changePassword(password) {
        return this.api.post('auth:change-password', password).then((res) => {
            return res;
        });
    }
    logout() {
        return this.api.post('auth:logout', null).then(res => res);
    }
};
